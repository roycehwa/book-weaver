...
def test_pipeline_exposes_translation_input_renderers() -> None:
    assert callable(pipeline_module.render_translation_input_markdown)
    assert callable(pipeline_module.render_book_markdown)
