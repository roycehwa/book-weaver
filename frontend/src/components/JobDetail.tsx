...
function JobDetail() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 lg:px-6">
      <Link to="/jobs" className="text-sm text-primary-700">返回书籍工作台</Link>
      <div className="mt-4 rounded-3xl border border-paper-200 bg-paper-50/90 p-6 shadow-sheet">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            <h1 className="text-3xl leading-tight text-ink-900">{job.source.filename}</h1>
          ...
          <span className={`rounded-full border px-3 py-1 text-sm font-medium ${
            job.state === 'failed' ? 'border-red-200 bg-red-100 text-red-700' : 'border-paper-200 bg-white text-ink-700'
          }`}>
            {workflowPathLabel}
          </span>
        </div>
        ...
        <div className="sticky bottom-4 z-20 mt-6 flex flex-wrap items-center gap-3 rounded-2xl border border-paper-200 bg-paper-50/95 p-3 shadow-sheet backdrop-blur">
